  ...
  Widget _buildMeterValue(double? value) {
    ...
    return FittedBox(
      ...
      child: Row(
        ...
        children: [
          Text(intPart, style: GoogleFonts.spaceMono(fontSize: 52, fontWeight: FontWeight.w700, color: _neuGreenDk, letterSpacing: 3)),
          Text('.', style: GoogleFonts.spaceMono(fontSize: 40, fontWeight: FontWeight.w700, color: _neuGreen)),
          Text(decPart, style: GoogleFonts.spaceMono(fontSize: 32, fontWeight: FontWeight.w400, color: _neuGreen.withOpacity(0.65), letterSpacing: 2)),
          const SizedBox(width: 8),
          Padding(
            padding: const EdgeInsets.only(bottom: 4),
            child: Text('m³', style: GoogleFonts.rajdhani(fontSize: 16, fontWeight: FontWeight.w600, color: _neuTextSec, letterSpacing: 1)),
          ),
        ],
      ),
    );
      ...
      body: SafeArea(
        child: StreamBuilder<List<MeterReading>>(
          ...
          builder: (context, snapshot) {
            ...
            final monthCost = _costService.calculateCost(monthConsumption, pricePerKwh: _kwhPrice, monthlyBasePrice: 0, brennwert: _brennwert, zustandszahl: _zustandszahl);
            final monthKwh = _costService.kwhFromM3(monthConsumption, brennwert: _brennwert, zustandszahl: _zustandszahl);
                      ...
                      children: [
                          ...
                          children: [
                              ...
                              child: _StatCard(
                                ...
                                onInfoTap: () => showDialog(
                                  ...
                                  builder: (_) => AlertDialog(
                                    ...
                                    content: Text('Für eine genauere Berechnung gib in den Einstellungen deinen Gas-Brennwert sowie deine Gas-Zustandszahl an. Diese Werte bekommst du von deinem Gas-Anbieter.', style: GoogleFonts.rajdhani(fontSize: 14, color: _neuTextSec, height: 1.5)),
                                    actions: [TextButton(onPressed: () => Navigator.of(context).pop(), child: Text('OK', style: GoogleFonts.rajdhani(fontSize: 14, fontWeight: FontWeight.w700, color: _neuGreen)))],
                                  ),
                                ),
                              ),
                            ),
                            ...
                            Expanded(
                              child: _StatCard(
                                ...
                                iconColor: _neuAmber,
                                onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => const CostDetailScreen())),
                              ),
                            ),
                          ],
                        ),
                        ...
                        ConsumptionChart(
                          ...
                          onExpand: () => Navigator.of(context).push(MaterialPageRoute(
                            builder: (_) => ChartFullscreenScreen(readings: readingPoints, unit: 'm³', accentColor: _neuGreen, accentDark: _neuGreenDk),
                          )),
                        ),
...
class _StatCard extends StatelessWidget {
  ...
  final VoidCallback? onTap, onInfoTap;
  const _StatCard({required this.label, required this.value, required this.unit, required this.icon, required this.iconColor, this.subValue, this.onTap, this.onInfoTap});
        ...
        child: Column(
          ...
          children: [
            Row(children: [
              ...
              if (onInfoTap != null)
                GestureDetector(onTap: onInfoTap, behavior: HitTestBehavior.opaque, child: Icon(Icons.info_outline_rounded, size: 16, color: _neuTextSec.withOpacity(0.5))),
            ]),
            ...
            if (subValue != null) ...[const SizedBox(height: 4), Text(subValue!, style: GoogleFonts.spaceMono(fontSize: 11, color: iconColor.withOpacity(0.75)))],
